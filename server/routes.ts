...
export default function setRoutes(app) {
  ...
  // Webhook
  router.route('/webhooks').get(webhookCtrl.getAll);
  router.route('/webhook').post(webhookCtrl.insert);
  router.route('/webhook/:id').get(webhookCtrl.get);
  router.route('/webhook/:id').put(webhookCtrl.update);
  router.route('/webhook/:id').delete(webhookCtrl.delete);
